<?php 
    ...
    $valueButton = "submit";
    $buttonString = "Kirim Event";

    switch($aksiModul){
        case 'buatArtikel':$judulBox = "Buat Event";break;
        case 'editArtikel':$judulBox = "Edit Event";break;
        default:$judulBox = "Artikel";break;
    }    
    ...
    if(isset($_GET['aksi_modul']) && $_GET['aksi_modul'] == "suntingArtikel"){
        $valueButton = "sunting";
        $buttonString = "Simpan Perubahan Artikel";
...
<!-- /TinyMCE -->
        ...
        <noscript>
            <div class="alert alert-block col-md-12">
                ...
                <p>Anda harus menggunakan <a href="http://en.wikipedia.org/wiki/JavaScript" target="_blank">JavaScript</a> untuk dapat menggunakan sistem ini.</p>
            </div>
        </noscript>
        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                ...
                <div class="page-header">
                    <h1>Buat Event
                        <small>tulis event untuk website anda</small>
                    </h1>
                </div>
                <div class="row">
                                <div class="box-content">
                                    <form role="form" method="post" action="modul/modul_artikel/proses_artikel.php">
                                        <input type="hidden" name="jenis_konten" value="artikel" />
                                        <?php if($_GET['aksi_modul'] == "suntingArtikel"): ?>
                                            <input type="hidden" name="id_konten" value="<?php echo $id_konten; ?>" />    
                                        <?php endif; ?>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Judul event</label>
                                            <input value="<?php echo $judul_konten; ?>" name="judul_konten" type="text" class="form-control" id="exampleInputEmail1" placeholder="Tulis judul event">
                                        </div>
                                        <div class="form-group">
                                            <textarea name="isi" cols="80" id="editor1" name="editor1" rows="10"><?php echo $isi; ?></textarea>
                                        </div>
                                        <button name="inputArtikel" value="<?php echo $valueButton; ?>" type="submit" class="btn btn-default"><?php echo $buttonString; ?></button>
                                    </form>
                        </div>
                </div>
                </div>
